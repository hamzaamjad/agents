<!-- Orchestration prompt template — canonical, versioned copy.
     Origin: hamzaamjad/tickets@b765bf8 (.prompts/orchestration/_template.md);
     bundled here 2026-06-10 so the skill is self-contained on any host.
     Usage: this file is the authoring source. Instantiate per-epic briefs
